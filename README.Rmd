...
# Data Example
Here we show how to use `regmedint()` to analyze an empirical dataset. We use an heart disease dataset from the UCI Machine Learning Repository: http://archive.ics.uci.edu/ml/datasets/Heart+Disease. We examine the effect of cholesterol level on the risk of heart disease. The exposure is cholesterol level, the outcome is heart disease, the mediator is blood pressure. Covariates include age, sex, chest pain, blood sugar, and maximum heart rate. 
...
# Formulas
See https://github.com/kaz-yos/regmedint-supplement/blob/master/supplement.pdf for the following formulas.
