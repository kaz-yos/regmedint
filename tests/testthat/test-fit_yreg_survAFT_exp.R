...
test_that("fit_yreg fit exponential AFT models with survreg correctly", {
...
test_that("fit_yreg fit exponential AFT models with survreg correctly with interaction", {
