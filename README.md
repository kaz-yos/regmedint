...
`c_cond` without re-fitting the underlyng
    models.
...
## mreg logistic yreg linear \_{TE} The gamma\[3,\] expression (\(\Gamma_{TE}\)) for the total effect standard error was corrected based on VV2013 Appendix p14.
