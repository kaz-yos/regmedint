...
regmedint_obj <- regmedint(data = vv2015,
                           ...
                           casecontrol = FALSE)
```
### Methods for for `regmedint`
All methods for the `regmedint` object has arguments `a0`, `a1`, `m_cde`, and `c_cond`. These are used to re-evaluate the results without re-fitting the underlying models.
